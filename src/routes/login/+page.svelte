...
<div class="min-h-screen flex items-center justify-center bg-base-200">
	<div class="card w-96 bg-base-100 shadow-xl">
		<div class="card-body items-center text-center">
			<img src="/sfh-logo.png" alt="Sing for Hope" class="h-20 mb-4" />
			<h2 class="card-title">PHWB Admin</h2>
			<p class="text-sm text-base-content/60 mb-4">Sign in with your Sing for Hope account</p>
